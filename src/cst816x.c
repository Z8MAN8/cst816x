...
#define DBG_TAG "cst816x"
#define DBG_LVL DBG_LOG
#include <rtdbg.h>

static struct rt_i2c_bus_device *i2c_bus = RT_NULL;

static rt_err_t cst816x_read_reg(rt_uint16_t addr, rt_uint8_t *cmd_buf, size_t cmd_len, rt_uint8_t *data_buf, size_t data_len)
{
...
static rt_err_t cst816x_write_reg(rt_uint16_t addr, rt_uint8_t *data_buf, size_t data_len)
{
...
static rt_size_t cst816x_read_point(struct rt_touch_device *touch, void *buf, rt_size_t read_num)
{
    ...
    else
    {
        ...
        if(cst816x_read_reg(CST816X_DEV_ADDR, cmd_buffer, 1, rx_data, 7) == RT_EOK)
        {
